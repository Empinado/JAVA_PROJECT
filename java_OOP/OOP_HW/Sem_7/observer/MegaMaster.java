...
public class MegaMaster implements Observer {
    ...
    public MegaMaster(String name, double minSalary, String desiredVacancy) {
        this.name = name;
        this.minSalary = minSalary;
        this.desiredVacancy = desiredVacancy;
    }

    public MegaMaster(String name) {
        this.name = name;
        minSalary = random.nextDouble(120000, 300000);
    }
